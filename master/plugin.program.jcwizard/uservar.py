...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]JC Wizard[/B][/COLOR]Wizard'
BUILDERNAME = 'Jchc4'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]JC[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]JC[/B][/COLOR]Wizard'
